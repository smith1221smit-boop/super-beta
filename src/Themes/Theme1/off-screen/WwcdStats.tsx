...
// state and the six manual socket event handlers. PublicThemeRenderer owns
// the single socket connection and passes freshly-merged matchData down as
// a prop — this component reads it directly, same recipe as MatchFragrs.tsx.
