...
// NOTE: local matchData state, propMatchData sync effect, and the REST
// fallback fetch removed. PublicThemeRenderer always supplies matchData as
// a prop for this view now.
