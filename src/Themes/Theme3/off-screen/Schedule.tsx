...
const Schedule: React.FC<ScheduleProps> = ({ tournament, round, matches: propMatches, matchDatas: propMatchDatas, selectedScheduleMatches }) => {
  // selectedMatchId isn't provided as a prop by PublicThemeRenderer for this
  // view — "UP NEXT" labeling below simply won't trigger without it. See
  // report for details.
  const selectedMatchId: string | null = null;
