...
// 'Champions' view — no more self-fetching here.
...
<div className='text-white text-[130px] font-[tungsten] absolute top-[-10px]'>CHAMPIONS - {tournament.tournamentName}</div>
  {/* Main gradient */}
  <div
