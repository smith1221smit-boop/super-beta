...
// NOTE: the self-fetch of `/api/public/rounds/:roundId/matches` (with
// loading/error state) is removed. PublicThemeRenderer already fetches the
// round's matches once and passes them down as the `matches` prop for the
// 'CommingUpNext' view — the "next match" is now derived from that prop.
