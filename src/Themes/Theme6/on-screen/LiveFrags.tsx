...
// handleBulkTeamUpdate) and the localMatchData mirror they wrote into.
...
// every change — this component just reads that prop directly now.
...
const LiveFrags: React.FC<LiveFragsProps> = ({ tournament, round, match, matchData }) => {
  // Local UI-only toggle — not derived from matchData, so it stays as its
  // own state and timer.
